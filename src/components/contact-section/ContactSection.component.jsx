...
const ContactSection = () => {
  return (
    ...
    <div className='mb-4'>
        ...
        <div className='mb-5'>
        <p><i className="fas fa-home me-3"></i>1-45,Udupi district,Karnataka,India</p>
            <p>
                <i className="fas fa-envelope me-3"></i>
                fancyhut@gmail.com
            </p>
            <p><i className="fas fa-phone me-3"></i> +91 9741941377</p>
            <p><i className="fas fa-print me-3"></i> +91 8217797401</p>
        </div>
